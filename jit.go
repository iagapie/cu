...
const (
	...
	JITTarget70  JITTargetOption = C.CU_TARGET_COMPUTE_70
	JITTarget72  JITTargetOption = C.CU_TARGET_COMPUTE_72
	JITTarget75  JITTargetOption = C.CU_TARGET_COMPUTE_75
	JITTarget80  JITTargetOption = C.CU_TARGET_COMPUTE_80
	JITTarget86  JITTargetOption = C.CU_TARGET_COMPUTE_86
	JITTarget87  JITTargetOption = C.CU_TARGET_COMPUTE_87
	JITTarget89  JITTargetOption = C.CU_TARGET_COMPUTE_89
	JITTarget90  JITTargetOption = C.CU_TARGET_COMPUTE_90
	JITTarget90A JITTargetOption = C.CU_TARGET_COMPUTE_90A
)
